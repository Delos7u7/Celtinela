...
function linkDevice() {
    ...
    fetch(`http://178.6.5.213:8080/linkDevice`, requestOptions)
        .then(response => {
            if (!response.ok) {
...
function getAlerts() {
    const url = `http://178.6.5.213:8080/getAlerts?id_vehiculo=${id_vehiculo}`;
    const requestOptions = {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' }
    };
...
function changeAlertState() {
    const url = `http://178.6.5.213:8080/changeAlertState?id_vehiculo=${id_vehiculo}`;
    const requestOptions = {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' }
    };
